...
[![pub package](https://img.shields.io/pub/v/install_pluginpro.svg)](https://pub.dartlang.org/packages/install_pluginpro)

We use the `install_pluginpro` plugin to install apk for android; and using url to go to app store for iOS.

## Usage

To use this plugin, add `install_pluginpro` as a dependency in your pubspec.yaml file. For example:
```yaml
dependencies:
  install_pluginpro: '^0.0.1'
```
